...
- [shareReplay](/api/operators/shareReplay) - Share with replay buffer
- [replay](/api/operators/replay) - Multicast with ReplaySubject
- [cache](/api/operators/cache) - Cache emissions
