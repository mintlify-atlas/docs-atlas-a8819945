...
- [share](/api/operators/share) - Automatically multicast with Subject
- [shareReplay](/api/operators/shareReplay) - Multicast with replay
- [multicast](/api/operators/multicast) - Multicast with custom Subject

## See Also

- [RxJS Subject documentation](https://rxjs.dev/api/index/class/Subject)
- [Multicasting Guide](/guides/multicasting)
- [Hot vs Cold Observables](/guides/hot-vs-cold)
