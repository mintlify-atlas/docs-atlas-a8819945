...
- [`defaultIfEmpty`](/api/operators/defaultIfEmpty) - Emits a default value if source completes without emitting
- [`of`](/api/operators/of) - Creates an Observable that emits specified values